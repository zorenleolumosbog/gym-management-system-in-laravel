...
<div class="wrapper animated fadeInDown">
    <div class="panel overflow-hidden">
        <div class="bg-blue-900 padding-40 no-margin-left font-size-20 color-white text-center text-uppercase">
            <img src="{{ asset('assets/img/web/fitness.png') }}">
            <center> Gym Login </center>
        </div>
        @if (count($errors) > 0)
        ...
        <form id="loginform" method="post" action="{{ url('/auth/login') }}">
            ...
            <div class="box-body padding-md">
                ...
                <button type="submit" class="btn btn-dark bg-red-500 padding-10 btn-block color-white"><i class="ion-log-in"></i> Sign in</button>
            </div>
        </form>
        <div class="panel-footer padding-md no-margin no-border bg-blue-900 text-center color-white">&copy; 2022 Gym Management System. All Right Reserved</div>
    </div>
</div>
